        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden lg:flex space-x-6 items-center">
              ...
              <Link
                to="/kontakt"
                className="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-md font-semibold text-sm transition-all shadow-lg hover:shadow-xl"
              >
                Erstberatung
              </Link>
            </nav>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link to="/wohngebaeude" className="hover:text-white flex items-center"><ChevronRight size={14} className="mr-1"/> Energieberatung Wohngebäude</Link></li>
                <li><Link to="/nichtwohngebaeude" className="hover:text-white flex items-center"><ChevronRight size={14} className="mr-1"/> DIN 18599 Nichtwohngebäude</Link></li>
                <li><Link to="/energieausweise" className="hover:text-white flex items-center"><ChevronRight size={14} className="mr-1"/> Energieausweise</Link></li>
                <li><Link to="/baubegleitung" className="hover:text-white flex items-center"><ChevronRight size={14} className="mr-1"/> Baubegleitung & Fördermittel</Link></li>
              </ul>
            </div>

            {/* Legal / Hours */}
            <div>
              <h4 className="text-lg font-semibold mb-4">Rechtliches & Zeiten</h4>
